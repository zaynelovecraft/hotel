...
function SupportWindow({ visible, loadchat }) {
  ...
  return (
    <div>
      <div
        className={`transition ease-in-out fixed right-[17px] z-20 ${
          visible === true ? `fixed ` : `hidden`
        } opacity-100 rounded-lg bottom-[111px] w-[325px] h-[500px] sm:w-[350px] sm:h-[500px] lg:w-[415px] lg:h-[560px]  shadow-lg bg-cyan-200 duration-300`}
      ></div>

      <div
        className={`transition ease-in-out fixed bottom-[116px] ${
          visible === true ? `fixed ` : `hidden`
