...
function Banner() {
  ...
  const images = [
    "/2.jpg",
    "/images/banner/rafael-cisneros-mendez-y5PG8ZecXQI-unsplash.jpg",
    "/images/banner/josiah-weiss-qMXXUvCH98Q-unsplash.jpg",
    "/images/banner/brian-yurasits-9pg_HAxUNcI-unsplash.jpg",
    "/images/banner/joceline-m-huitzil-kLrZ67Y4bB8-unsplash.jpg",
  ];
  return (
