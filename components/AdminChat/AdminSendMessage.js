...
function AdminSendMessage({talk}) {
  ...
  return (
    <div>
        <form className='flex absolute bottom-0 left-[0.1rem] bg-white items-center align-middle rounded-lg w-[100%] mr-[0.1rem] border-2 border-gray-200 pl-4 pr-2 py-2 '>
        <input
            value={message}
